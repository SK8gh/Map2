...
def create_distances_file(vehicle_type):
    ...
    np.save(f".../Desktop/MAP2/data/times_{vehicle_type}.npy", get_distance_instance.times)
    np.save(f".../Desktop/MAP2/data/speeds_{vehicle_type}.npy", get_distance_instance.speeds)
